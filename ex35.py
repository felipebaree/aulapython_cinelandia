...
#1)Crie um programa que peça ao usuário para digitar números repetidamente. O programa deve parar de pedir números quando o usuário digitar 0. A cada número digitado, use um if para verificar se ele é positivo. O programa deve somar apenas os números positivos e, no final, exibir o resultado da soma.
